package
{
	...
	public class PlayState extends FlxState
	{
		...
		{			
			...
			FlxG.score = 0;
			_scoreText = new FlxText(113, 20, 100, "0");
		...
		override public function update():void
		{
			...
			FlxVelocity.moveTowardsObject(_enemy, _player, 5);
			FlxVelocity.moveTowardsObject(_enemy2, _player, 5);
			FlxVelocity.moveTowardsObject(_enemy3, _player, 5);
