package
{
	...
	public class PlayState5 extends FlxState
	{
		...
		{			
			...
			FlxG.score = 145;
			_scoreText = new FlxText(100, 20, 130, "145");
		...
		override public function update():void
		{
			...
			FlxVelocity.moveTowardsObject(_enemy, _player, 55);
			FlxVelocity.moveTowardsObject(_enemy2, _player, 55);
			FlxVelocity.moveTowardsObject(_enemy3, _player, 55);
		...
		{
			var textwin:FlxText;
			textwin = new FlxText(90, 90, 150, "Congrats! You robber all the world!");
			textwin.color = 0xffffff;
			textwin.alignment = "center";
			textwin.size = 16;
			add(textwin);
