package
{
	...
	public class PlayState3 extends FlxState
	{
		...
		{			
			...
			FlxG.score = 65;
			_scoreText = new FlxText(100, 20, 130, "65");
		...
		override public function update():void
		{
			...
			FlxVelocity.moveTowardsObject(_enemy, _player, 30);
			FlxVelocity.moveTowardsObject(_enemy2, _player, 30);
			FlxVelocity.moveTowardsObject(_enemy3, _player, 30);
