package
{
	...
	public class PlayState2 extends FlxState
	{
		...
		{			
			...
			FlxG.score = 30;
			_scoreText = new FlxText(113, 20, 100, "30");
		...
		override public function update():void
		{
			...
			FlxVelocity.moveTowardsObject(_enemy, _player, 20);
			FlxVelocity.moveTowardsObject(_enemy2, _player, 20);
			FlxVelocity.moveTowardsObject(_enemy3, _player, 20);
